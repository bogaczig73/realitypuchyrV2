            ...
            <div className="header-bar flex justify-between">
                ...
                <ul className="list-none mb-0 space-x-1">
                    ...
                    <li className="dropdown inline-block relative">
                        ...
                        <div className={`${showCountry ? 'show' : 'hidden'} dropdown-menu absolute end-0 m-0 mt-4 z-10 w-36 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm shadow-gray-200 dark:shadow-gray-700`}>
                            <ul className="list-none py-2 text-start">
                                <li className="my-1">
                                    <Link href="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><Image src='/images/flags/germany.png' width={24} height={24} className="h-6 w-6 rounded-md me-2 shadow-sm shadow-gray-200 dark:shadow-gray-700" alt=""/> German</Link>
                                </li>
                                <li className="my-1">
                                    <Link href="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><Image src='/images/flags/germany.png' width={24} height={24} className="h-6 w-6 rounded-md me-2 shadow-sm  shadow-gray-200 dark:shadow-gray-700" alt=""/> Italian</Link>
                                </li>
                                <li className="my-1">
                                    <Link href="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><Image src='/images/flags/russia.png' width={24} height={24} className="h-6 w-6 rounded-md me-2 shadow-sm shadow-gray-200  dark:shadow-gray-700" alt=""/> Russian</Link>
                                </li>
                                <li className="my-1">
                                    <Link href="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><Image src='/images/flags/spain.png' width={24} height={24} className="h-6 w-6 rounded-md me-2 shadow-sm shadow-gray-200 dark:shadow-gray-700" alt=""/> Spanish</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
