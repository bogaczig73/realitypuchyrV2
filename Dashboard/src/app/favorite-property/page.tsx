            ...
            <div className="container-fluid relative px-3">
                <div className="layout-specing">
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                        {propertiesData.map((item:PropertiesData,index:number) =>{
                            return(
                                <div className="group rounded-xl bg-white dark:bg-slate-900 shadow-sm hover:shadow-xl dark:hover:shadow-xl shadow-gray-200 dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500 w-full mx-auto" key={index}>
                                    <div className="md:flex">
                                        <div className="relative md:shrink-0">
                                            <img src={item.image} className="h-full w-full object-cover md:w-48" alt=""/>
