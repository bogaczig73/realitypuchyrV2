                                ...
                                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px] -mt-24">
                                    ...
                                    <div className="lg:col-span-2 md:col-span-4">
                                        ...
                                        <ul className="list-none footer-list mt-6">
                                            ...
                                            <li className="mt-[10px]"><Link href="/pricing" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Pricing</span> </Link></li>
                                            <li className="mt-[10px]"><Link href="/blogs" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Blog</span> </Link></li>
                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <ul className="list-none footer-list mt-6">
                                              ...
                                              <li className="mt-[10px]"><Link href="/grid" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Listing</span> </Link></li>
                    ...
                    <div className="container text-center">
                        <div className="grid md:grid-cols-2 items-center gap-6">
                            ...
                            <ul className="list-none md:text-end text-center">
                                ...
                                <li className="inline ms-1"><Link href="mailto:support@shreethemes.in" className="btn btn-icon btn-sm text-gray-400 hover:text-white border border-gray-800 dark:border-gray-700 rounded-md hover:border-green-600 dark:hover:border-green-600 hover:bg-green-600 dark:hover:bg-green-600"><FiMail className="h-4 w-4"></FiMail></Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
