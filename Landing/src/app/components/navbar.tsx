                ...
                <div className={`${topnavClass !== '' && topnavClass !== undefined ? 'container-fluid md:px-8 px-3' : 'container'}`}>
                    ...
                    <div id="navigation" className={`${isOpen === true ? 'hidden' : 'block'}`} >
                        ...
                        <ul className={`navigation-menu  ${navClass === '' || navClass === undefined ? '' : 'nav-light'}   ${topnavClass !== '' && topnavClass !== undefined ? '!justify-center' : '!justify-end'}`}>
                            <li className={`has-submenu parent-menu-item ${["/", "/index-two", "/index-three", "/index-four","/index-five", "/index-six", "/index-seven","/index-eight","/index-nine","/index-ten"].includes(manu) ? 'active' : ''}`}>
                                <Link href="#" onClick={(e)=>{setSubManu(subManu === "/index-item" ? "" : "/index-item")}}>Home</Link><span className="menu-arrow"></span>
                                <ul className={`submenu megamenu ${["/", "/index-two", "/index-three", "/index-four", "/index-five", "/index-six","/index-seven","/index-item","/index-eight","/index-nine","/index-ten"].includes(subManu) ? 'open' : ''}`}>
                                    <li>
                                        <ul>
                                            <li className={manu ===  "/" ? 'active' : '' }>
                                                <Link href="/" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-one.png' width={183} height={124} className="img-fluid rounded shadow-md" alt=""/></span>
                                            ...
                                            <li className={manu ===  "/index-two" ? 'active' : '' }>
                                                <Link href="/index-two" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-two.png' width={183} height={124}  className="img-fluid rounded shadow-md" alt=""/></span>
                                        ...
                                        <ul>
                                            <li className={manu ===  "/index-three" ? 'active' : '' }>
                                                <Link href="/index-three" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-three.png' width={183} height={124}  className="img-fluid rounded shadow-md" alt=""/></span>
                                            ...
                                            <li className={manu ===  "/index-four" ? 'active' : '' }>
                                                <Link href="/index-four" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-four.png' width={183} height={124}  className="img-fluid rounded shadow-md" alt=""/></span>
                                        ...
                                        <ul>
                                            <li className={manu ===  "/index-five" ? 'active' : '' }>
                                                <Link href="/index-five" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-five.png' width={183} height={124}  className="img-fluid rounded shadow-md" alt=""/></span>
                                            ...
                                            <li className={manu ===  "/index-six" ? 'active' : '' }>
                                                <Link href="/index-six" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-six.png' width={183} height={124}  className="img-fluid rounded shadow-md" alt=""/></span>
                                        ...
                                        <ul>
                                            <li className={manu ===  "/index-seven" ? 'active' : '' }>
                                                <Link href="/index-seven" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-seven.png' width={183} height={124}  className="img-fluid rounded shadow-md" alt=""/></span>
                                            ...
                                            <li className={manu ===  "/index-eight" ? 'active' : '' }>
                                                <Link href="/index-eight" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-eight.png' width={183} height={124}  className="img-fluid rounded shadow-md" alt=""/></span>
                                        ...
                                        <ul>
                                            <li className={manu ===  "/index-nine" ? 'active' : '' }>
                                                <Link href="/index-nine" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-nine.png' width={183} height={124}  className="img-fluid rounded shadow-md" alt=""/></span>
                                            ...
                                            <li className={manu ===  "/index-ten" ? 'active' : '' }>
                                                <Link href="/index-ten" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-ten.png' width={183} height={124} className="img-fluid rounded shadow-md" alt=""/></span>
